  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-secondary/5">
      ...
      <main className="container mx-auto px-4 lg:px-8 py-10 space-y-10">
        {/* Welcome Banner */}
        <div className="relative overflow-hidden rounded-2xl bg-primary shadow-xl shadow-primary/10 dark:shadow-primary/20 p-8 text-primary-foreground">
          ...
          <div className="relative z-10">
            ...
            <p className="text-primary-foreground/90 max-w-xl text-lg">
              Manage your church community with powerful attendance tracking and member management tools.
            </p>
          </div>
        </div>
